export const projects = {
    gamestreams: {
        title: 'Gamestreams',
        shortDescription: '',
        description: 'I and my friend had a problem that we were unable to watch E-Sport events from big screens, so we decided to solve it. We developed and published a GameStreams app for the LG store, during the App lifecycle we had averaged over 10k downloads monthly while maintaining in TOP 3 rated application in all regions. After Twitch successfully launched its official application we decided to close down our app. ',
        thumbnail: '',
        startYear: '2016',
        endYear: '2019',
    ...
    westbygg: {
        title: 'Westbygg',
        shortDescription: '',
        description: 'Westbygg is a small company based in central Estonia. They produce exclusive handmade log cabins for their customers. They value nature highly and have continued to build log cabins for their customers using traditional manual crafting methods, therefore, saving energy and nature.',
        thumbnail: '',
        startYear: '2021',
        endYear: null,
    ...
    minutv: {
        ...
        description: 'MinuTV was the first experient of Telia Estonia to deliver TV content to both web and mobile devices using HLS streaming technology. I performed QA duties at that project implementing automated tests using Nightwatch.js on top of Selenium. MinuTV had around 50k subscribers at the time, few years laters UI and product were overhauled to a single service which is used to date.',
        thumbnail: '',
        startYear: '2014',
        endYear: '2016',
    ...
    simote: {
        ...
        description: 'Simote was developed to replace manual labor from TV testing. TV hardware is controlled with IR via remote and testing it manually was very time-consuming, so Simote was born in Tartu in a company called Stagnationlab. Simote allowed users to record user behavior and playback actions on multiple TV or set-top box manufacturer hardware. My role was to analyze requirements, help with acceptance testing, and train fellow colleagues.',
        thumbnail: '',
        startYear: '2013',
        endYear: '2014',
